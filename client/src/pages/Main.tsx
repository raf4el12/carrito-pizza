...
import useAuthContext from '../context/AuthContext'; // Asumo que existe y funciona

// --- ÍCONOS COMO COMPONENTES SVG ---
// Es una buena práctica tenerlos en archivos separados, pero los pongo aquí por simplicidad.
const PizzaIcon = () => (
...
// --- DATOS DE CARACTERÍSTICAS Y TESTIMONIOS ---
const features = [
  {
